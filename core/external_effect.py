...
def create_effect(aios_dir, contract_id, logical_operation_id, actor):
    ...
    rec = {"record_type":"EXTERNAL_EFFECT","effect_id":effect_id,"contract_id":contract_id,"logical_operation_id":logical_operation_id,"actor":actor,"state":"PLANNED","attempt":0,"created_at":_now(),"updated_at":_now()}
